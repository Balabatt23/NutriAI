        ...
        <div class="bg-white rounded-3xl shadow-lg p-8">    
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 flex justify-center items-center w-full">
                    <a href="{{ route('google_redirect') }}" class="w-full">
                        <button class="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-xl bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors">
